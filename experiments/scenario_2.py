...
#initialization
with open(os.path.join(os.path.dirname(__file__), '..', 'config', 'scenario_2.yaml')) as f:
...
for r in rs:
    ...
    result_dir = os.path.join(os.path.dirname(__file__), '..', 'results', 'scenario_2', f'seed_{r}')
